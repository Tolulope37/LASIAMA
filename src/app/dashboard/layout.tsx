...
export default function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-gray-800 dark:bg-gray-900 transition-all duration-300 flex flex-col`}>
        {/* Logo */}
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            {sidebarOpen && (
              <div>
                <h1 className="text-white font-bold text-lg">LASIAMA</h1>
                <p className="text-gray-400 text-xs">Asset Platform</p>
              </div>
            )}
          </div>
        </div>
